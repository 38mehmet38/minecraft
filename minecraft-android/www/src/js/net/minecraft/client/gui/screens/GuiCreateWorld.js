...
export default class GuiCreateWorld extends GuiScreen {
    ...
    init() {
        ...
        this.buttonList.push(new GuiButton("Yeni Dünya Oluştur", this.width / 2 - 155, y + 110, 150, 20, () => {
        ...
        this.buttonList.push(new GuiButton("İptal", this.width / 2 + 5, y + 110, 150, 20, () => {
    ...
    drawScreen(stack, mouseX, mouseY, partialTicks) {
        ...
        // Title
        this.drawCenteredString(stack, "Yeni Dünya Oluştur", this.width / 2, 50);

        let y = this.height / 2 - 50;

        // Seed
        this.drawString(stack, "Dünya Oluşturucu Tohumu", this.width / 2 - 100, y + 17, -6250336);
        this.drawString(stack, "Rastgele bir tohum için boş bırakın", this.width / 2 - 100, y + 55, -6250336);

...
export default class GuiDisconnected extends GuiScreen {
    ...
    init() {
        ...
        this.buttonList.push(new GuiButton("Tamam", this.width / 2 - 100, y + 130, 200, 20, () => {
    ...
    drawScreen(stack, mouseX, mouseY, partialTicks) {
        ...
        // Render title
        this.drawCenteredString(stack, "Sunucudan bağlantı kesildi:", this.width / 2, this.height / 2 - 20, 0x80FFFFFF);

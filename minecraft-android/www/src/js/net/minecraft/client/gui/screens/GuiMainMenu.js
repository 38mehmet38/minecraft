...
export default class GuiMainMenu extends GuiScreen {
    ...
    constructor() {
        ...
        this.splashText = "Minecraft JavaScript ile yazılmış!";
    }
    ...
    init() {
        ...
        this.buttonList.push(new GuiButton("Tek Oyuncu", this.width / 2 - 100, y, 200, 20, () => {
            this.minecraft.displayScreen(new GuiCreateWorld(this));
        }));
        this.buttonList.push(new GuiButton("Çok Oyuncu", this.width / 2 - 100, y + 24, 200, 20, () => {
            this.minecraft.displayScreen(new GuiDirectConnect(this));
        }));
        this.buttonList.push(new GuiButton("Ayarlar...", this.width / 2 - 100, y + 72 + 12, 98, 20, () => {
            this.minecraft.displayScreen(new GuiOptions(this));
        }));
        this.buttonList.push(new GuiButton("Oyunu Kapat", this.width / 2 + 2, y + 72 + 12, 98, 20, () => {
            this.minecraft.stop();
        }));
    ...
    drawScreen(stack, mouseX, mouseY, partialTicks) {
        ...
        // Draw version
        this.drawString(stack, "GÜLMEZ STUDİO", 2, this.height - 10, 0xFFFFFFff);

        // Draw copyright
        let mouseOver = mouseX > this.width / 2 + 70 && mouseY > this.height - 20;
        this.drawRightString(stack, "", this.width - 2, this.height - 10, mouseOver ? 0xFF00FFFF : 0xFFFFFFff);

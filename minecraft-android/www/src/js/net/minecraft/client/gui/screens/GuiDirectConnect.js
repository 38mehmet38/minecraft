...
export default class GuiDirectConnect extends GuiScreen {
    ...
    init() {
        ...
        this.buttonList.push(new GuiButton("Bağlan", this.width / 2 - 155, y + 110, 150, 20, () => {
    ...
    drawScreen(stack, mouseX, mouseY, partialTicks) {
        ...
        // Title
        this.drawCenteredString(stack, "Sunucuya Bağlan", this.width / 2, 50);

        let y = this.height / 2 - 50;

        // Seed
        this.drawString(stack, "Sunucu Adresi", this.width / 2 - 100, y + 17, -6250336);
